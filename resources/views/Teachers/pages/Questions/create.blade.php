                    ...
                    <form action="{{ route('teacher.questions.store') }}" method="post">
                        ...
                        <div class="form-row">
                            <div class="form-group col">
                                <label for="exam_id">{{ trans('Exam_trans.exam_name') }}</label>
                                <input type="hidden" name="exam_id" id="exam_id"
                                       class="form-control form-control-alternative" value="{{$exam->id }}">
                                <input type="text"  id="exam_id"
                                       class="form-control form-control-alternative" readonly value="{{$exam->exam_name }}">
                                @error('exam_id')
