...
@section('page-header')
    ...
    <div class="page-title">
        <div class="row">
            <div class="col-sm-6">
                <h4 class="mb-0">{{ trans('Fees_trans.add_new_fees') }}</h4>
            </div>
            <div class="col-sm-6">
                <ol class="breadcrumb pt-0 pr-0 float-left float-sm-right ">
                    <li class="breadcrumb-item"><a href="#" class="default-color">{{ trans('main_trans.Accounts') }}</a>
                    </li>
                    <li class="breadcrumb-item active">{{ trans('Fees_trans.add_new_fees') }}</li>
                </ol>
            </div>
        </div>
    </div>
        ...
        <div class="col-xl-12 mb-30">
            <div class="card card-statistics h-100">
                <div class="card-body">
                    ...
                    <form method="post" action="{{ route('feese.store') }}" autocomplete="off">
                        @csrf
                        <div class="form-row">
