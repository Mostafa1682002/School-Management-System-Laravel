...
@inject('parent', 'App\Models\Myparent')
                        ...
                        <div class="card-body">
                            <div class="clearfix">
                                ...
                                <div class="float-right text-right">
                                    <h4 class="card-text text-dark">{{ trans('Dashboard_trans.num_students') }}</h4>
                                    <h5>{{ $student->count() }}</h5>
                                </div>
                            </div>
                    ...
                    <div class="card card-statistics h-100">
                        <div class="card-body">
                            <div class="clearfix">
                                ...
                                <div class="float-right text-right">
                                    <h4 class="card-text text-dark">{{ trans('Dashboard_trans.num_teachers') }}</h4>
                                    <h5>{{ $teacher->count() }}</h5>
                                </div>
                            </div>
                            <h6 class="text-muted pt-3 mb-0 mt-2 border-top">
                    ...
                    <div class="card card-statistics h-100">
                        <div class="card-body">
                            <div class="clearfix">
                                ...
                                <div class="float-right text-right">
                                    <h4 class="card-text text-dark ">{{ trans('Dashboard_trans.num_parents') }}</h4>
                                    <h5>{{ $parent->count() }}</h5>
                                </div>
                            </div>
                            <h6 class="text-muted pt-3 mb-0 mt-2 border-top">
                                <i class="fas fa-eye mr-1" aria-hidden="true"></i><a href="{{ route('add_parent') }}"
                ...
                <div class="col-xl-3 col-lg-6 col-md-6 mb-30">
                    <div class="card card-statistics h-100">
                        <div class="card-body">
                            ...
                            <h6 class="text-muted pt-3 mb-0 mt-2 border-top">
                                <i class="fas fa-eye mr-1" aria-hidden="true"></i><a
                                    href="{{ route('classes.index') }}" target="_blank"><span class="text-danger">
                                        {{ trans('Dashboard_trans.show_data') }}
                                    </span></a>
                            </h6>
                        </div>
