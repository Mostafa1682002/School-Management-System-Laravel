                ...
                <ul class="nav navbar-nav side-menu" id="sidebarnav">
                        ...
                        <ul id="students-menu" class="collapse">
                            <li>
                                ...
                                <ul id="Student_information" class="collapse">
                                    <li> <a
                                            href="{{ route('student.index') }}">{{ trans('Student_trans.page_title') }}</a>
                                    </li>
                                    <li> <a
                                            href="{{ route('student.create') }}">{{ trans('Student_trans.add_page_title') }}</a>
                                    </li>
                                </ul>
                            </li>
                    ...
                    <li>
                        ...
                        <ul id="Teachers-menu" class="collapse" data-parent="#sidebarnav">
                            <li> <a href="{{ route('teacher.index') }}">{{ trans('Teacher_trans.page_title') }}</a>
                            </li>
                        </ul>
                    </li>
