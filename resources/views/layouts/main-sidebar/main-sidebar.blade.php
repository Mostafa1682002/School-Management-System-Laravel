<ul class="nav navbar-nav side-menu" id="sidebarnav">
    ...
    <li>
        ...
        <ul id="Grades-menu" class="collapse" data-parent="#sidebarnav">
            <li><a href="{{ route('schoolGrade.index') }}">{{ trans('SchoolGrades_trans.page_title') }}</a>
            </li>
        </ul>
    </li>
    <!-- classes-->
    ...
    <li>
        ...
        <ul id="sections-menu" class="collapse" data-parent="#sidebarnav">
            <li> <a href="{{ route('section.index') }}">{{ trans('Sections_trans.page_title') }}</a>
            </li>
        </ul>
    </li>
        ...
        <ul id="students-menu" class="collapse">
            <li>
                ...
                <ul id="Student_information" class="collapse">
                    <li> <a href="{{ route('students.index') }}">{{ trans('Student_trans.page_title') }}</a>
                    </li>
                    <li> <a href="{{ route('students.create') }}">{{ trans('Student_trans.add_page_title') }}</a>
                    </li>
                </ul>
            </li>
            ...
            <li>
                ...
                <ul id="Students_upgrade" class="collapse">
                    <li> <a href="{{ route('promotion.index') }}">{{ trans('Student_trans.list_promotion') }}</a>
                    </li>
                    <li> <a href="{{ route('promotion.create') }}">{{ trans('Student_trans.add_promotion') }}</a>
                    </li>
                </ul>
            </li>
            ...
            <li>
                <a href="javascript:void(0);" data-toggle="collapse"
                    data-target="#Graduate students">{{ trans('Student_trans.graduated') }}<div class="pull-right"><i
                            class="ti-plus"></i></div>
                    <div class="clearfix"></div>
                </a>
                <ul id="Graduate students" class="collapse">
                    <li> <a href="{{ route('graduated.index') }}">{{ trans('Student_trans.graduated_list') }}</a>
                    </li>
                    <li> <a href="{{ route('graduated.create') }}">{{ trans('Student_trans.graduate_student') }}</a>
                    </li>
                </ul>
            </li>
        </ul>
    ...
    <li>
        ...
        <ul id="Teachers-menu" class="collapse" data-parent="#sidebarnav">
            <li> <a href="{{ route('teachers.index') }}">{{ trans('Teacher_trans.page_title') }}</a>
            </li>
        </ul>
    </li>
    ...
    <li>
        ...
        <ul id="Accounts-menu" class="collapse" data-parent="#sidebarnav">
            <li> <a href="{{ route('feese.index') }}">{{ trans('Fees_trans.study_fees') }}</a> </li>
            <li>
                <a href="{{ route('feese_invoice.index') }}">{{ trans('Fees_invoice_trans.fees_ivoice') }}</a>
            </li>
        </ul>
    </li>
    ...
    <li>
        ...
        <ul id="Attendance-icon" class="collapse" data-parent="#sidebarnav">
            <li> <a href="{{ route('attendance.index') }}">{{ trans('Attendance_trans.page_title') }}</a>
            </li>
        </ul>
    </li>
    <!-- Subjects-->
    <li>
        ...
        <ul id="subject-icon" class="collapse" data-parent="#sidebarnav">
            <li> <a href="{{ route('subject.index') }}">{{ trans('Subject_trans.page_title') }}</a>
            </li>
        </ul>
    </li>
    ...
    <li>
        ...
        <ul id="Exams-icon" class="collapse" data-parent="#sidebarnav">
            <li> <a href="{{ route('exam.index') }}">{{ trans('Exam_trans.page_title') }}</a> </li>
            <li> <a href="{{ route('questions.create') }}">{{ trans('Question_trans.add_page_title') }}</a>
            </li>
        </ul>
    </li>
    <!-- Books-->
    <li>
        ...
        <ul id="library-icon" class="collapse" data-parent="#sidebarnav">
            <li> <a href="{{ route('books.index') }}">{{ trans('Books_trans.page_title') }}</a> </li>
        </ul>
    </li>
    ...
    <li>
        ...
        <ul id="Onlineclasses-icon" class="collapse" data-parent="#sidebarnav">
            <li> <a href="{{ route('online-classes.index') }}">{{ trans('OnlineClasses_trans.page_title') }}</a>
            </li>
        </ul>
    </li>
